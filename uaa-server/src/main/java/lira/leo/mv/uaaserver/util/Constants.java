package lira.leo.mv.uaaserver.util;

/**
 * Constantes globais para configuração do serviço
 * 
...
public interface Constants {
	...
	public static final String VALUE_SPRING_CONFIG_NAME = "uaa-server";
	public static final String VALUE_SPRING_APPLICATION_NAME = "uaa-server";
