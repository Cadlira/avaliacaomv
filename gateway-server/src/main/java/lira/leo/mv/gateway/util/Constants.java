package lira.leo.mv.gateway.util;

/**
 * Constants para configuração do serviço
 * 
...
public interface Constants {
	...
	public static final String VALUE_SPRING_CONFIG_NAME = "gateway-server";
	public static final String VALUE_SPRING_APPLICATION_NAME = "gateway-server";
