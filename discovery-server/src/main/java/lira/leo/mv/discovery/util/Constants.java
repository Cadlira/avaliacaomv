package lira.leo.mv.discovery.util;
...
public interface Constants {
	...
	public static final String VALUE_SPRING_CONFIG_NAME = "discovery-server";
	public static final String VALUE_SPRING_APPLICATION_NAME = "discovery-server";
